...
namespace DjvuNet.Tests.Xunit
{
    public class DjvuDataRowTestCase : TestMethodTestCase, IXunitTestCase
    {
        ...
        public DjvuDataRowTestCase(IMessageSink messageSink,
                             TestMethodDisplay defaultMethodDisplay,
                             ITestMethod testMethod,
                             int attributeNumber,
                             int rowNumber)
            : base(defaultMethodDisplay, testMethod, GetTestMethodArguments(testMethod, attributeNumber, rowNumber, messageSink))
        {
