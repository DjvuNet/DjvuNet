...
namespace DjvuNet.Graphics.Tests
{
    ...
    {
        /// <summary>
        /// A concrete implementation of the abstract Map class used specifically for testing internal map logic.
        /// </summary>
        private class TestMap : Map
        {
            public TestMap(int ncolors, int redOffset, int greenOffset, int blueOffset, bool isRampNeeded) 
                : base(ncolors, redOffset, greenOffset, blueOffset, isRampNeeded) { }
            public new void SetWidth(int width) => base.SetWidth(width);
            public new void SetHeight(int height) => base.SetHeight(height);
        }
        ...
        {
            TestMap map = new TestMap(1, 0, 0, 0, false);
        ...
        {
            TestMap map = new TestMap(3, 0, 0, 0, false);
        ...
        {
            TestMap map = new TestMap(5, 0, 0, 0, false);
