        ...
        public static IMap2 Read(IDjvuReader reader)
        {
            ...
            switch (header16)
            {
                case 0xffd8:
                    ...
                    else throw new DjvuFormatException($"Unexpected JPEG file header: ff d8 {buffer[2].ToString("x")}");
                ...
                case 0x8950:
                    ...
                    else throw new DjvuFormatException($"Unexpected PNG file header.");
                ...
                case 0x4749:
                    ...
                    else throw new DjvuFormatException($"Unexpected GIF file header.");
                ...
                case 0x4d4d:
                    ...
                    else throw new DjvuFormatException($"Unexpected TIFF file header.");

                case 0xff4f:
                    // JPEG 2000 header                     -> ff 4f ff 51 ff 52
                    if (buffer[2] == 0xff && buffer[3] == 0x51 && buffer[4] == 0xff && buffer[5] == 0x52)
                        return ReadJpeg2k(reader);
                    else throw new DjvuFormatException($"Unexpected JPEG 2000 file header.");
                ...
                case 0x574d:
                    ...
                    else throw new DjvuFormatException($"Unexpected JPEG XR file header.");

                case 0x762f:
                    // OpenEXR header                       -> 76 2f 31 01
                    if (buffer[2] == 0x31 && buffer[3] == 0x01)
                        return ReadOpenExr(reader);
                    else throw new DjvuFormatException($"Unexpected OpenEXR file header.");
                ...
                case 0x5249:
                    ...
                    else throw new DjvuFormatException($"Unexpected WebP file header.");

                case 0x0000:
                    // ICO | CUR header                     -> 00 00 ( 01 | 02 ) 00
                    if ((buffer[2] == 0x01 || buffer[2] == 0x02) && buffer[3] == 0x00)
                        return ReadIco(reader);
                    else throw new DjvuFormatException($"Unexpected ICO | CUR file header.");
                ...
                case 0x4250:
                    ...
                    else throw new DjvuFormatException($"Unexpected BPG file header.");
                ...
                case 0xab4b:
                    ...
                    else throw new DjvuFormatException($"Unexpected PKM file header.");
                default:
