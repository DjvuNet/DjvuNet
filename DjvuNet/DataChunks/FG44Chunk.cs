...
namespace DjvuNet.DataChunks
{
    ...
    public class FG44Chunk : DjvuNode, IFG44Chunk
    {
        ...
        public FG44Chunk(IDjvuWriter writer, IDjvuElement parent, long length = 0)
        ...
        internal IInterWavePixelMap DecodeForegroundImage()
        {
            ...
            {
                IInterWavePixelMap foreground = new InterWavePixelMapDecoder();
                foreground.Decode(reader);
